...
| `KEELSON_PROJECTS_ROOT=~/code/keelson` | Override the projects root (default: `~/keelson/projects`). The bundled `default` project lives at `<root>/_default/`; `/api/projects/clone` clones into `<root>/<name>/`. |
