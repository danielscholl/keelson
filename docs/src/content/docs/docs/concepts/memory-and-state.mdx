...
state-changing endpoints are gated to loopback origins; "local-only" is a
property of the wiring, not a promise in the README.
...
Nothing else is silently added. If the agent knows something across
sessions, it came through one of those four doors, and three of them are
files or rows you can read.
