...
| `artifacts/` | Published [canvas artifacts](../../guides/canvas-artifacts/), one `<slug>.html` page (openable in any browser) plus a `<slug>.json` sidecar; re-registered at boot. |
