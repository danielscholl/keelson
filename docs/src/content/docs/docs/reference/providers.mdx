...
model classes and defaults. The catalogs below document baseline ids where
available. Operators can replace the derived ids with per-provider
[`modelClasses` settings](../../guides/configuration/#claude-credentials).
