// A fixture rib exercising every v2 contract hook: view descriptor, composeBundle,
// a workflow contribution bound to a namespaced snapshot key (with a fail-closed
// validator), an action handler (onAction), and an auth-status probe that reads a
// namespaced credential.
